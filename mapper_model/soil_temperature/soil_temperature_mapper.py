...
query_insert_soil_temperature = 'INSERT INTO data_hub (' \
...
class SoilTemperatureMapper(Mapper):
    ...
    def insert_items(self, items):
        with connect(self.dbc) as conn:
            ...
            with conn.cursor() as curs:
                ...
                extras.execute_values(curs, query_insert_soil_temperature, data, template=None, page_size=100)
