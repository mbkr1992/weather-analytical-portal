...
query_insert_visibility = 'INSERT INTO data_hub (' \
    ...
    def insert_items(self, items):
        with connect(self.dbc) as conn:
            ...
            with conn.cursor() as curs:
                ...
                extras.execute_values(curs, query_insert_visibility, data, template=None, page_size=100)
